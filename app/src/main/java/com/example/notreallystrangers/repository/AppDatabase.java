...
//		AppDatabase db = AppDatabase.getInstance(this);
		...
		db.questionDao().insertQuestion(new Question("honest dating", "final", "Ask literally anything. Permission to go there."));
		...
		db.questionDao().insertQuestion(new Question("inner circle", "final", "Ask me something you think is off limits. Both players."));
		...
		db.questionDao().insertQuestion(new Question("relationship", "final", "Write down your intention for our relationship. Compare."));
		...
		db.questionDao().insertQuestion(new Question("breakup", "final", "Write down 3 things about your last relationship that you will no longer accept moving forward. Get specific. "));
		...
		db.questionDao().insertQuestion(new Question("own it", "final", "Write down 3 things you're most grateful for in this present moment. Big or small."));
